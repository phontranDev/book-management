    ...
    // Dashboard Routes
    {
      ...
      children: [
        ...
        },
        {
          path: 'my-user',
          children: [
            { element: <Navigate to="/dashboard/my-user/profile" replace /> },
            { path: 'profile', element: <UserAppProfile /> },
            { path: 'list', element: <UserAppList /> },
            { path: 'new', element: <UserAppCreate /> },
            { path: ':name/edit', element: <UserAppCreate /> },
            { path: 'account', element: <UserAppAccount /> }
          ]
        },
        {
          path: 'blog',
        ...
        },
        {
          path: 'post',
          children: [
            { element: <Navigate to="/dashboard/post/list" replace /> },
            { path: 'list', element: <PostList /> },
            { path: ':slug', element: <PostDetail /> },
            { path: 'new-post', element: <PostCreate /> },
            { path: ':slug/edit', element: <PostCreate /> }
          ]
        },
        {
          path: 'book',
          children: [
            { element: <Navigate to="/dashboard/book/list" replace /> },
            { path: 'list', element: <BookList /> },
            { path: ':slug', element: <BookDetails /> },
            { path: 'new-book', element: <BookCreate /> },
            { path: ':slug/edit', element: <BookCreate /> }
          ]
        },
        {
          path: 'mail',
...
const BookList = Loadable(lazy(() => import('../pages/dashboard/BookList')));
const BookCreate = Loadable(lazy(() => import('../pages/dashboard/BookCreate')));
const BookDetails = Loadable(lazy(() => import('../pages/dashboard/BookDetails')));

const PostList = Loadable(lazy(() => import('../pages/dashboard/PostList')));
const PostDetail = Loadable(lazy(() => import('../pages/dashboard/PostDetail')));
...
const UserAppProfile = Loadable(lazy(() => import('../pages/dashboard/UserAppProfile')));
const UserAppList = Loadable(lazy(() => import('../pages/dashboard/UserAppList')));
const UserAppAccount = Loadable(lazy(() => import('../pages/dashboard/UserAppAccount')));
const UserAppCreate = Loadable(lazy(() => import('../pages/dashboard/UserAppCreate')));
