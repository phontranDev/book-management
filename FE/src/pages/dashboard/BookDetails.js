...
import { Box, Tab, Card, Grid, Divider, Skeleton, Container, Typography, Button } from '@mui/material';
                        ...
                        {book.softFile && (
                          <>
                            <Worker workerUrl="https://unpkg.com/pdfjs-dist@2.4.456/build/pdf.worker.min.js">
                              <div className="post-article-container" style={{ height: '750px' }}>
                                <Viewer
                                  key={123}
                            ...
                            {open && (
                              <>
                                ...
                                <Helmet>
                                  <script data-name="demo" async="canonical" src="/demo.js" />
                                </Helmet>
                              </>
                            )}
                          </>
